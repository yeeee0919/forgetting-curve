...
export function createTourDemoCards() {
    ...
    return [
        { ...base, id: 'tour_demo_huis', front: 'huis', back: '房子', interval: 0 },
        { ...base, id: 'tour_demo_fiets', front: 'fiets', back: '腳踏車', status: STATUS.REVIEW, interval: 4 * 24 * 60 * 60 * 1000, repetitions: 2 },
        { ...base, id: 'tour_demo_water', front: 'water', back: '水', status: STATUS.NEW, repetitions: 0, interval: 0, dueDate: now },
        {
            ...base,
