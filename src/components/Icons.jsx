...
const PATHS = {
    ...
    puzzle: (
        <path d="M7 7.5h1.6a2.4 2.4 0 0 0 4.8 0H15a2 2 0 0 1 2 2v1.1a2.4 2.4 0 0 1 0 4.8V16.5a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2v-1.1a2.4 2.4 0 0 0 0-4.8V9.5a2 2 0 0 1 2-2z" />
    ),
    plus: (
        <>
