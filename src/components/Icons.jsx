...
const PATHS = {
    ...
    puzzle: (
        <path d="M6.5 7h3a2.5 2.5 0 0 0 5 0H17.5A2.5 2.5 0 0 1 20 9.5v3a2.5 2.5 0 0 1 0 5v2A2.5 2.5 0 0 1 17.5 22H6.5A2.5 2.5 0 0 1 4 19.5v-2a2.5 2.5 0 0 0 0-5v-3A2.5 2.5 0 0 1 6.5 7z" />
    ),
    /** Word Catcher：捕蟲網（與擴充／Catch 品牌呼應） */
    catchNet: (
        <>
            <ellipse cx="14" cy="9" rx="6" ry="5.5" />
            <path d="M8.5 7.5 19.5 10.5" />
            <path d="M9.5 11.5 18.5 7" />
            <path d="M14 3.5v11" />
            <path d="M9.2 13.2 3.8 20.2" />
            <path d="M3.8 20.2h3.4" />
            <path d="M17.5 4.2l1.2-1.6M19.2 5.8l1.8-.4M18.8 8.2l1.6.9" />
        </>
    ),
    plus: (
        <>
